...
|---------|------|------------|
| [2.0.0](https://github.com/Biopasks/todo-list/releases/tag/v2.0.0) | 2026-05-25 | Task navigation, avatar context, enterprise footer |
| [1.1.0](https://github.com/Biopasks/todo-list/releases/tag/v1.1.0) | 2026-04-15 | Timer, alarms, profile system, avatar constructor |
| [1.0.0](https://github.com/Biopasks/todo-list/releases/tag/v1.0.0) | 2026-03-01 | Initial release |
...
<p align="center">
  <sub>See the full release history on [GitHub Releases](https://github.com/Biopasks/todo-list/releases).</sub>
</p>

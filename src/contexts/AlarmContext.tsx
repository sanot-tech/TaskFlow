...
interface AlarmContextType {
  ...
  ALARM_SOUNDS: typeof ALARM_SOUNDS;
  startTimer: (taskId: string, taskTitle: string, duration: number) => boolean;
  stopTimer: (taskId: string) => void;
  toggleAlarmSystem: () => void;
  setSelectedSound: (soundId: string) => void;
  formatTime: (seconds: number) => string;
  getTimeForTask: (taskId: string) => string | null;
...
// Custom hook to use alarm context
